      ...
      <ul className="mt-6 flex flex-col gap-6">
        {MOCK_NEWS.map((item) => (
          <li key={item.id}>
            <a
              href="#"
              className="flex items-center justify-between gap-4 rounded-xl py-1 transition-colors outline-none hover:bg-muted/60 focus-visible:ring-2 focus-visible:ring-ring/30"
