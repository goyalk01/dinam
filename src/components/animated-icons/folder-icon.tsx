...
const flapVariants: Variants = {
  normal: { d: "M20 20H4a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h3.93a2 2 0 0 0 1.66-.9l.82-1.2a2 2 0 0 1 1.66-.9H20a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2Z" },
  animate: {
  ...
  ({ onMouseEnter, onMouseLeave, className, size = 24, ...props }, ref) => {
    ...
    return (
      ...
      >
        ...
        >
          <path d="M2 10V6a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2v1" opacity="0.6" />
