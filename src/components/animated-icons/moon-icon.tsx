...
export function MoonIcon({ className, size = 24, onMouseEnter, onMouseLeave, ...props }: MoonIconProps) {
  ...
  return (
    ...
    >
      ...
      >
        <motion.g variants={moonVariants} style={{ transformOrigin: "12px 12px" }}>
